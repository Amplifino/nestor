...
public class StatementWrapper extends WrapperWrapper implements Statement {
	...
	private final SqlConsumer<Statement> onClose;
	
	protected StatementWrapper(Statement statement) {
		this(statement, Statement::close);
	}

	protected StatementWrapper(Statement statement, SqlConsumer<Statement> onClose) {
		super(statement);
